...
Facets 2.8.0 takes the next evolutionary step for Facets in the vein of 2.7.0.
However, 2.8 also reverts a few of the deprecations made in the last version.
These libs will remain in Facets's MORE library for the forseeable future.
This version effectively concludes the MORE library "clean-up". The next
verison of Facets will focus on "auditing" of the CORE library.

Changes:

* 4 Libraries Undeprecated:
...
* 1 Library Deprecated:

  * fileable.rb
  
* 6 Libraries Spun-Off And Deprecated:
...
* Additonal Enhancements:
  ...
  * Fixed kernel#d so it is now useable.
  ...
  * Other minor improvements (thanks to ccjr)
