...
This release consists of just a few minor deprecations and additions.
It is primarily a "touch-up" release, prior to the next major 3.0 release.
...
* New Features
  ...
  * Add Kernel#hierarchically, which supports #hierarchical_send.
...
* Improved Features
  ...
  * Imporve FileUtils#amass to be more robust.

* Bug Fixes

  * Fix Hash#rekey to keep default_proc.
  * Conditionally define Binding#self for Rubinius.
...
* Implementation Details
  ...
  * Consolidated library into two parts, `core` and `standard`.
  * Old term `more`, a synonym for `standard`, may be phased out.
