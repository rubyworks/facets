...
This is a record of some musings along the way in the creation of
Facets. It is not in any way all that important. Its' simply here
to give some historical context to development and to provide any
...
== Some convesion extensions that turned out to be bad.
...
== Enumerable#defer
  ...
  Is is possible to write Enumerable#defer as an all inclusive method?
