...
* Renamed Features
  ...
  * Module#modname          was Module#parent_name
...
* Bug Fixes
  ...
  * String#edit_distance use new encodings for Ruby 1.9
...
* Other Imrpovements
  ...
  * Moved module/enclosure.rb to optional tour lib
