...
This release is fairly extensive as it was orginally intended to be v3.0.
After further consideration it was decided to reserve 3.0 for the
polish that only real world feedback can provide. The primrary thrust
of this release was to finish trimming Facets to be primarily a core
extensions library. With this release almost all addon classes and mixins
have now been spu-off to other projects. Only the most general purposes
classes and mixins remain.

A new TOUR division has been added to complement CORE and MORE. This
lib division houses purely optional core extensions. The new division serves
a couple of useful puposes. In particular, it helps separates the standard
library extensions for optional core extension in the RDocs and thus makes
...
extensions you want, thus avoiding any conflicts. There are actaully only a
...
* New Features
  ...
  * na.rb provides NA class
  * Memoizable in memoizable.rb provides a more robust memoization system
  * thread.rb adds Module#safe_memo for thread safe memoization

* Deprecations

  * Module#attr_toggler has been removed for YAGNI
  * Kernel#class_eval has been removed b/c of it's confusing behavior
  * Module#once is no longer an alias for #memoize
  * Integer#succ(n) has been removed (for compatibility reasons)
  * Deprecated Stackable, it's method were moved to CORE
  * Deprecated Kernel#populate and #set_from (use #assign and #assign_from)
  * partial.rb no longer defines X or #__, use NA instead
  * autoreload.rb has been spun-off to a separate project
  * Deprecated Kernel#non_nil? since #not_nil? is enough
  * Deprecated #__HERE__ b/c implementation was unreliable
  * Deprecated Array#upto and Indexable#upto, use #thru instead
  * Deprecated Time#since, use #ago instead
  * Deprecated Time#advance, use #in instead  TODO
  * Deprecated Kernel#super_as (no good way to get callers method name)
  * Deprecated Integer#clear_bit, use #bit_clear instead
  * Deprecated Kernel#resc, use String#to_re or #to_rx instead

* Renamed Features

  * Module#enclosure        was Module#parent
  * Module#enclosures       was Module#parents
  * Module#namespace        was Module#parent_name
  * Array#recurse           was Array#recurisvely       
  * Hash#recurse            was Hash#recurisvely
  * Enumerable#recursively  was Enumerable#recursive
  * Array#recursively       was Array#recursive
  * Hash#recursively        was Hash#recursive           
  * Kernel#disable_warnings was Kernel#silence_warnings
  * Hash#deep_merge         was Hash#recursive_merge
  * Class#preallocate       was Class#prepend
  * FileUtils#atomic_write  was File#atomic_write
  * Module#method_clash     was Module#conflict
  * Module#class_inheritor  was Class#inheritor   ? TODO
  * Symbol#as_s             was Symbol#re_s
  * String#characters       was String#chars
  * String#unindent         was String#outdent
  * Hash#reverse_merge      was Hash#merge

* Moved Libraries

  * roman.rb has been moved to integer/roman and string/roman.rb
  * blank.rb has been moved to kernel/blank.rb
  * facets-live.rb has been moved to facets/auto_core.rb
  * Moved cattr.rb to More library
  * Moved duplicable.rb to kernel/dup.rb
  * Moved bitmask.rb to integer/bitmask.rb

* Bug Fixes

  * Fixed Hash#rekey! from clobbering previous keys
  * Exception#raised? is a class method
  * Enumerator#fx should use #map instead of #each
  * String#splice needs String#store
  * Kernel#blank? empty condition was faulty
  * Comparable#bound needs clip.rb, not cap.rb
  * String#file needs to pass block

* Other Imrpovements

  * New `tour` division of lib
  ...
  * Moved #divide and #split from Enumerable to Array
  * Moved #entropy, #probability and #duplicates from Enumerable to Array
  * Kernel#try is like ActiveSupport version. 
  * Improved #respond (which is like old #try)
  * Dot not use if defined?(ActiveSupport)
