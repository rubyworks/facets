...
changes over the course of the 2.6.x series, the decision was made to let 2.7 meet them
all at once. In so doing this release nearly completes the process of trimming down
the MORE library to the essentials. Over 30 high-level libraries have been spun-off
as separate gems and over 10 other libraries have been deprecated for varying reasons.

A few other changes have been made that may also effect your code. In particular you
should note that #class_extension has been renamed to #class_extend
